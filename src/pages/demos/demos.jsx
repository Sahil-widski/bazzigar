                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home1-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/1.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Main Demo</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home1-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/01.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Main Demo</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home2-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/2.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home2-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/02.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Creative Agency</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/mobile-app/mobile-app-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/mobile1.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Mobile app</h6>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/mobile-app/mobile-app-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/mobile2.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Mobile app</h6>
                          <div className="sta new">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home7-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/n2.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Freelancer</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home7-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/n02.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Freelancer</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home8-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/n3.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Architecture</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home8-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/n03.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Architecture</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home5-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/3.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home5-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/03.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Digital Agency</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home4-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/4.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home4-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/04.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Business One Page</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home3-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/5.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home3-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/05.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Corporate Business</h6>
                        </div>
              ...
              <div className="gallery full-width">
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home6-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/n1.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Modern Agency</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/homepage/home6-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/n01.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Modern Agency</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <span className="dot"></span>
                    <div className="img">
                      <imgsrc="/demo-img/c3.png" alt="image" />
                    </div>
                    <div className="cont">
                      <h6>Restaurant</h6>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <span className="dot"></span>
                    <div className="img">
                      <imgsrc="/demo-img/c4.png" alt="image" />
                    </div>
                    <div className="cont">
                      <h6>Multipurpose</h6>
                      <div className="sta coming">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/showcase/showcase-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/s1.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Full Screen</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/showcase/showcase-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/s01.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Full Screen</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/showcase4/showcase4-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/s2.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/showcase4/showcase4-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/s02.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Showcase Carousel</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/showcase3/showcase3-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/s3.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/showcase3/showcase3-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/s03.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Showcase Circle</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/works/works-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/w1.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/works/works-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/w01.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Works 3 column</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/works2/works2-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/w2.png" alt="image" />
                        </div>
                        <div className="cont">
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/works2/works2-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/w02.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Works Filtering</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/works3/works3-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/w3.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Works Gallery</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/works3/works3-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/w03.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Works Gallery</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/blog-list/blog-list-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/blog-list-dark.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Blog List</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/blog-grid/blog-grid-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/blog-grid-dark.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Blog Grid</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/about/about-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/about.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>About Us</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/about/about-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/about1.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>About Us</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/contact/contact-dark">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/contact-dark.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Contact</h6>
                        </div>
                ...
                <div className="col-lg-3 col-md-6 items">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <Link href="/contact/contact-light">
                      <a target="_blank">
                        <div className="img">
                          <imgsrc="/demo-img/contact-light.png" alt="image" />
                        </div>
                        <div className="cont">
                          <h6>Contact</h6>
                        </div>

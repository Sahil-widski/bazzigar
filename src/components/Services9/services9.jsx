        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="serv-img md-mb50">
              <img src={"/img/mobile-app/app-img/bet.jpg"} alt="" />
            </div>
          </div>
          <div className="col-lg-6 offset-lg-1 valign">
            <div className="content">
              <h6 className="stit mb-30">
                <span className="left"></span> Legacy of 20 years
              </h6>
              <h2 className="mb-30">
                We are the most trusted gaming & betting platform in India.
              </h2>
              <p>
                We take immense pride in being the most trusted gaming and
        ...
        <div className="row mt-80">
          <div className="col-lg-6 valign">
            <div className="content md-mb50">
              <h6 className="stit mb-30">
                <span className="left"></span> Betting bole toh bazzigarexchange
              </h6>
              <h2 className="mb-30">
                Money Double guarantee
              </h2>
              <p>
          ...
          <div className="col-lg-5 offset-lg-1">
            <div className="serv-img">
              <img
                src={"/img/mobile-app/app-img/newbet.jpg"}
                style={{ height: 500 }}
                alt=""
              />
            </div>

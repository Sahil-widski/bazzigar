...
const _asynclocalstorage = __webpack_require__(1244);
...
const _normalizetrailingslash = __webpack_require__(8387);
...
const _approuter = __webpack_require__(6924);
...
const _routerreducer = __webpack_require__(1381);
const _routerreducertypes = __webpack_require__(9956);
const _createhreffromurl = __webpack_require__(765);
const _hooksclientcontext = __webpack_require__(9569);
const _usereducerwithdevtools = __webpack_require__(1479);
const _errorboundary = __webpack_require__(6519);
const _createinitialrouterstate = __webpack_require__(560);
const _isbot = __webpack_require__(8735);
const _addbasepath = __webpack_require__(3675);
const _approuterannouncer = __webpack_require__(1036);
const _redirectboundary = __webpack_require__(3426);
const _findheadincache = __webpack_require__(1682);
const _infinitepromise = __webpack_require__(8165);
...
function urlToUrlWithoutFlightMarker(url) {
    ...
    if (true) {
        if ( true && urlWithoutFlightParameters.pathname.endsWith(".txt")) {
            ...
            const length = pathname.endsWith("/index.txt") ? 10 : 4; // Slice off `/index.txt` or `.txt` from the end of the pathname
  ...
  */ const appRouter = (0, _react.useMemo)(()=>{
        const routerInstance = {
            ...
            prefetch: (href, options)=>{
                ...
                const url = new URL((0, _addbasepath.addBasePath)(href), location.href); // External urls can't be prefetched in the same way.
    ...
    if (false) {} // When mpaNavigation flag is set do a hard navigation to the new url.
...
const _dynamicnossr = __webpack_require__(7174);
const _staticgenerationasyncstorage = __webpack_require__(7326);
...
const _interop_require_default = __webpack_require__(2147);
const _react = /*#__PURE__*/ _interop_require_default._(__webpack_require__(8038));
const _navigation = __webpack_require__(600);
const styles = {
    error: {
...
const _approutercontext = __webpack_require__(7085);
const _fetchserverresponse = __webpack_require__(7223);
const _infinitepromise = __webpack_require__(8165);
const _errorboundary = __webpack_require__(6519);
const _matchsegments = __webpack_require__(8921);
const _handlesmoothscroll = __webpack_require__(7887);
const _redirectboundary = __webpack_require__(3426);
const _notfoundboundary = __webpack_require__(633);
const _getsegmentvalue = __webpack_require__(22);
const _createroutercachekey = __webpack_require__(9456);
/**
 ...
 */ function InnerLayoutRouter(param) {
    ...
    const { buildId, changeByServerResponse, tree: fullTree } = context; // Read segment path from the parallel router cache node.
    ...
    */ // When the data has not resolved yet `use` will suspend here.
        const [flightData, overrideCanonicalUrl] = (0, _react.use)(childNode.data); // segmentPath from the server does not match the layout's segmentPath
...
const _approutercontext = __webpack_require__(7085);
const _hooksclientcontext = __webpack_require__(9569);
const _clienthookinservercomponenterror = __webpack_require__(2190);
const _getsegmentvalue = __webpack_require__(22);
const _serverinsertedhtml = __webpack_require__(9618);
const _redirect = __webpack_require__(3174);
const _notfound = __webpack_require__(877);
...
function useSearchParams() {
    ...
    if (true) {
        ...
        const { bailoutToClientRendering } = __webpack_require__(6644);
...
function getSelectedParams(tree, params) {
    ...
    for (const parallelRoute of Object.values(parallelRoutes)){
        ...
        if (!segmentValue || segmentValue.startsWith("__PAGE__")) continue; // Ensure catchAll and optional catchall are turned into an array
...
const _requestasyncstorage = __webpack_require__(9093);
...
const _approutercontext = __webpack_require__(7085);
const _filllazyitemstillleafwithhead = __webpack_require__(2289);
const _fillcachewithnewsubtreedata = __webpack_require__(9248);
...
const _createhreffromurl = __webpack_require__(765);
const _filllazyitemstillleafwithhead = __webpack_require__(2289);
const _computechangedpath = __webpack_require__(9191);
...
const _approuterheaders = __webpack_require__(9851);
const _approuter = __webpack_require__(6924);
const _appcallserver = __webpack_require__(5266);
const _routerreducertypes = __webpack_require__(9956);
...
const _approutercontext = __webpack_require__(7085);
const _invalidatecachebyrouterstate = __webpack_require__(6957);
const _filllazyitemstillleafwithhead = __webpack_require__(2289);
const _createroutercachekey = __webpack_require__(9456);
...
function handleMutable(state, mutable) {
    var _mutable_shouldScroll; // shouldScroll is true by default, can override to false.
...
const _fetchserverresponse = __webpack_require__(7223);
const _createrecordfromthenable = __webpack_require__(7454);
const _readrecordvalue = __webpack_require__(6667);
const _createhreffromurl = __webpack_require__(765);
const _applyrouterstatepatchtotree = __webpack_require__(8738);
const _isnavigatingtonewrootlayout = __webpack_require__(4405);
const _navigatereducer = __webpack_require__(3387);
const _handlemutable = __webpack_require__(4053);
const _applyflightdata = __webpack_require__(3009); // A version of refresh reducer that keeps the cache around instead of wiping all of it.
...
const _readrecordvalue = __webpack_require__(6667);
const _createhreffromurl = __webpack_require__(765);
const _invalidatecachebelowflightsegmentpath = __webpack_require__(4987);
const _fillcachewithdataproperty = __webpack_require__(658);
const _createoptimistictree = __webpack_require__(6480);
const _applyrouterstatepatchtotree = __webpack_require__(8738);
const _shouldhardnavigate = __webpack_require__(7934);
const _isnavigatingtonewrootlayout = __webpack_require__(4405);
const _routerreducertypes = __webpack_require__(9956);
const _handlemutable = __webpack_require__(4053);
const _applyflightdata = __webpack_require__(3009);
const _getprefetchcacheentrystatus = __webpack_require__(2771);
const _pruneprefetchcache = __webpack_require__(3996);
const _prefetchreducer = __webpack_require__(4071);
...
function navigateReducer(state, action) {
    ...
    if (forceOptimisticNavigation && (prefetchValues == null ? void 0 : prefetchValues.kind) !== _routerreducertypes.PrefetchKind.TEMPORARY) {
        ...
        const res = (0, _fillcachewithdataproperty.fillCacheWithDataProperty)(temporaryCacheNode, state.cache, optimisticFlightSegmentPath, fetchResponse, true); // If optimistic fetch couldn't happen it falls back to the non-optimistic case.
        if (!(res == null ? void 0 : res.bailOptimistic)) {
            mutable.previousTree = state.tree;
    ...
    _prefetchreducer.prefetchQueue.bump(data); // Unwrap cache data with `use` to suspend here (in the reducer) until the fetch resolves.
    ...
    for (const flightDataPath of flightData){
        ...
        const treePatch = flightDataPath.slice(-3)[0]; // TODO-APP: remove ''
        const flightSegmentPathWithLeadingEmpty = [
            "",
            ...flightSegmentPath
        ]; // Create new tree based on the flightSegmentPath and router state patch
        let newTree = (0, _applyrouterstatepatchtotree.applyRouterStatePatchToTree)(flightSegmentPathWithLeadingEmpty, currentTree, treePatch); // If the tree patch can't be applied to the current tree then we use the tree at time of prefetch
...
const _pruneprefetchcache = __webpack_require__(3996);
const _approuterheaders = __webpack_require__(9851);
const _promisequeue = __webpack_require__(5432);
...
function prefetchReducer(state, action) {
    ...
    **/ if (!(cacheEntry.kind === _routerreducertypes.PrefetchKind.AUTO && action.kind === _routerreducertypes.PrefetchKind.FULL)) {
    ...
    const serverResponse = (0, _createrecordfromthenable.createRecordFromThenable)(prefetchQueue.enqueue(()=>(0, _fetchserverresponse.fetchServerResponse)(url, state.tree, state.nextUrl, state.buildId, action.kind))); // Create new tree based on the flightSegmentPath and router state patch
...
function serverActionReducer(state, action) {
    ...
    try {
        ...
        const { actionResult, actionFlightData, redirectLocation, revalidatedParts } = (0, _readrecordvalue.readRecordValue)(action.mutable.inFlightServerAction); // Invalidate the cache for the revalidated parts. This has to be done before the
...
const _routerreducertypes = __webpack_require__(9956);
const _navigatereducer = __webpack_require__(3387);
const _serverpatchreducer = __webpack_require__(4212);
const _restorereducer = __webpack_require__(9625);
const _refreshreducer = __webpack_require__(8829);
const _prefetchreducer = __webpack_require__(4071);
const _fastrefreshreducer = __webpack_require__(7472);
const _serveractionreducer = __webpack_require__(1973);
/**
...
const _staticgenerationbailout = __webpack_require__(1918);
...
const _hooksservercontext = __webpack_require__(808);
const _staticgenerationasyncstorage = __webpack_require__(7326);
...
const _interop_require_default = __webpack_require__(2147);
const _react = /*#__PURE__*/ _interop_require_default._(__webpack_require__(8038));
const _searchparamsbailoutproxy = __webpack_require__(6442);
...
const _addlocale = __webpack_require__(6549);
const _routercontext = __webpack_require__(7160);
const _approutercontext = __webpack_require__(7085);
const _useintersection = __webpack_require__(7458);
const _getdomainlocale = __webpack_require__(8610);
const _addbasepath = __webpack_require__(3675);
const _routerreducertypes = __webpack_require__(9956);
 ...
 */ const Link = /*#__PURE__*/ _react.default.forwardRef(function LinkComponent(props, forwardedRef) {
    ...
    legacyBehavior = true === false } = props, restProps = _objectWithoutProperties(props, _excluded);
...
const _headmanager = __webpack_require__(6031);
const _requestidlecallback = __webpack_require__(6966);
...
function Script(props) {
    const { id, src = "", onLoad = ()=>{}, onReady = null, strategy = "afterInteractive", onError, stylesheets } = props, restProps = _objectWithoutProperties(props, _excluded); // Context is available only during SSR
...
const _interop_require_default = __webpack_require__(2147);
const _react = /*#__PURE__*/ _interop_require_default._(__webpack_require__(8038));
const _nossrerror = __webpack_require__(91);
function suspense() {
...
module.exports = createProxy("/Users/dashdub/Documents/Baziggar/vie/node_modules/next/dist/client/components/app-router.js");
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7176);
module.exports = createProxy("/Users/dashdub/Documents/Baziggar/vie/node_modules/next/dist/client/components/error-boundary.js");
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7176);
module.exports = createProxy("/Users/dashdub/Documents/Baziggar/vie/node_modules/next/dist/client/components/layout-router.js");
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7176);
module.exports = createProxy("/Users/dashdub/Documents/Baziggar/vie/node_modules/next/dist/client/components/render-from-template-context.js");
...
const _staticgenerationbailout = __webpack_require__(8286);
function createSearchParamsBailoutProxy() {
    return new Proxy({}, {
        get (_target, prop) {
            // React adds some properties on the object when serializing for client components
...
const _hooksservercontext = __webpack_require__(536);
const _staticgenerationasyncstorage = __webpack_require__(7326);
class StaticGenBailoutError extends Error {
    constructor(...args){
        super(...args);
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7176);
module.exports = createProxy("/Users/dashdub/Documents/Baziggar/vie/node_modules/next/dist/client/components/static-generation-searchparams-bailout-provider.js");
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(7176);
module.exports = createProxy("/Users/dashdub/Documents/Baziggar/vie/node_modules/next/dist/client/script.js");
...
if (true) {
    module.exports = __webpack_require__(2805);
} else {}
 ...
 * LICENSE file in the root directory of this source tree.
 */ 
var aa = __webpack_require__(7175), ba = __webpack_require__(3998), l = null, m = 0;
function n(a, b) {
...
const { default: AppRouter } = __webpack_require__(898);
const { default: LayoutRouter } = __webpack_require__(7390);
const { default: RenderFromTemplateContext } = __webpack_require__(4065);
const { staticGenerationAsyncStorage } = __webpack_require__(7326);
const { requestAsyncStorage } = __webpack_require__(9093);
const { actionAsyncStorage } = __webpack_require__(1676);
const { staticGenerationBailout } = __webpack_require__(8286);
const { default: StaticGenerationSearchParamsBailoutProvider } = __webpack_require__(3147);
const { createSearchParamsBailoutProxy } = __webpack_require__(8971);
const serverHooks = __webpack_require__(536);
const { renderToReadableStream, decodeReply, decodeAction } = __webpack_require__(8453);
const { preloadStyle, preloadFont, preconnect } = __webpack_require__(6918);
...
const _reactdom = /*#__PURE__*/ _interop_require_default(__webpack_require__(3998));
...
module.exports = __webpack_require__(4750)
